...
%imgDataPaths = fileList(~cellfun(@isempty,regexp(fileList,'.pic')));
...
allSparks.Properties.VariableUnits = ... 
            {'' '' '' '' '' '' '' 'minutes' '#sp*100um-1*s-1' '#sp*100um-1*s-1' ...
            'deltaF/F0' 'ms' 'ms' 'ms' 'um' 'deltaF/F0*um^3' 'ms' 'deltaF/F0*ms' '' '' 'um' 'ms'};
