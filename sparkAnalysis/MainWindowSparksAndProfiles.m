...
check_visRect = uicontrol('Style', 'checkbox', 'Parent',hp_SD,...
    ...
    'Position',[0.325 0.445 0.4 0.1],...
    'Callback',{@checkRectVisibility, mainFig});

check_bsFit = uicontrol('Style', 'checkbox', 'Parent',hp_SD,...
    'FontUnits','normalized', 'Value',0, ...
    'Units','normalized', 'FontSize',0.75,...
    'String','baseline linear fit', ...
    'Position',[0.325 0.335 0.4 0.1],...
    'Callback','');
...
switch analysisType
    case 'spark detection'   
        ...
        check_saveEventsFigs = uicontrol('Style', 'checkbox', ...
            ...
            'Position',[0.01 0.6 0.95 0.1]);
        uicontrol('Style','text', ...
            'FontUnits','normalized',...
            'Parent',hp_Analysis, 'Units','normalized', 'FontSize',0.4,...
            'Position',[0.01 0.35 0.6 0.2], ...
        ...
        h_edit_res = uicontrol('Style', 'edit', ...
            ...
            'Position',[0.625 0.375 0.35 0.15], ...
