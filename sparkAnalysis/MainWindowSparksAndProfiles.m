...
h_edit_baseIter = uicontrol('Style','edit', 'String','6',...
    'Parent',hp_crit, 'Units','normalized', ...
...
switch analysisType
    ...
    otherwise % PROFILES
        ...
        h_bsDet_edit = uicontrol('Style','edit', 'String','85',...
            'FontUnits','normalized', 'FontSize',0.55,...
...
switch analysisType
    case 'spark detection'   
        ...
        uicontrol('Style','text', ...
            ...
            'Parent',hp_Analysis, 'Units','normalized', ...
            'FontSize',0.6,...
            'Position',[0.01 0.475 0.68 0.125], ...
        ...
        uicontrol('Style','text', ...
            ...
            'Parent',hp_Analysis, 'Units','normalized', ...
            'FontSize',0.6,...
            'Position',[0.01 0.325 0.68 0.125], ...
            'String',{'# events per page:'});
        h_edit_numOfEvntsPerPage = uicontrol('Style', 'edit', ...
            'String','12', 'Parent',hp_Analysis, ...
            'Units','normalized', 'FontUnits','normalized', ...
            'Position',[0.69 0.325 0.3 0.15], ...
            'Units','normalized', 'FontSize',0.6, ...
            'TooltipString','# events per page in pdf output file. Possible # = [1,2,4,9,12]',...
            'Callback','');
        ...
        hObjs.h_edit_numOfEvntsPerPage = h_edit_numOfEvntsPerPage;
