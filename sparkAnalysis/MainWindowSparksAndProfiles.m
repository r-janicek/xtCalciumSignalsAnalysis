...
h_bg_sld = uibuttongroup('Visible','on', 'Parent',mainFig, ...
    'Units','normalized', 'Position',[0.8 0.975 0.125 0.025],...
...
h_table_notes = uitable( ...
    'Data',{'ctrl';'5 uM fluo-3 AM (30 mins, RT)';'';'';''},...
    'ColumnEditable',true,...
...
switch analysisType
    ...
    case 'spark detection'
        ...
        txt_correctedSpF = uicontrol('Style','text', ...
            ...
            'Units','normalized', 'FontSize',0.275,...
            'Position',[0.725 0 0.275 0.3], ...
            'String',{'#';['sp*100',char(956),'m-1*s-1']},...
            'ForegroundColor','r');
...
switch analysisType
    case 'spark detection'   
        ...
        h_pb_batchAnalysis = uicontrol('Style', 'pushbutton',...
            ...
            'FontUnits','normalized', 'FontSize',0.275, ...
            'FontWeight','bold',...
            'Parent',hp_Analysis, 'Units','normalized', ...
