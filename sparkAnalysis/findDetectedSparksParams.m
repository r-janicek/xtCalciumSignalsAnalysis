    ...
    for i = 1:length(statSparks)
        ...
        if hObjs.check_showEventsFigs.Value
            ...
            ax_txt_b = axes(hf, 'Units','normalized', ...
                'Position',[dx 1-4*dy-h_a-2*dy 1-4*dx 2*dy], ...
                'Visible','off');
            text(ax_txt_b, 0, 1,  ...
                [txt_b, ...
                join(params_txt, ' // ')], ...
            ...
            hp_reFit = uipanel('Title','re-fit event', ...
                ...
                'Position',[0.8 0.01 0.19 0.19], ...
                'FontUnits','normalized', 'FontWeight','bold',...
                'FontSize',0.175, 'FontAngle','italic');
            uicontrol('Style','text',...
                'Parent',hp_reFit, 'Units','normalized',...
                'Position',[0.01 0.5 0.4 0.4], ...
            ...
            h_smooth_reFit = uicontrol('Style','edit', 'String','50',...
                ...
                'Position',[0.41 0.5 0.24 0.4]);
            uicontrol('Style','text', ...
                'FontUnits','normalized',...
                'Parent',hp_reFit, 'Units','normalized', 'FontSize',0.375,...
                'Position',[0.01 0.05 0.5 0.4],...
            ...
            uicontrol('Style', 'pushbutton',...
                ...
                'FontWeight','bold',...
                'Parent',hp_reFit, 'Units','normalized', ...
                'Position',[0.675 0.2 0.3 0.6],...
                'Callback',{@refitSelectedEvent, sparkROInum, mainFig}, ...
                'Enable','on');
            setappdata(hf, 'h_smooth_reFit', h_smooth_reFit)
            setappdata(hf, 'h_bsDet_reFit', h_bsDet_reFit)
        end
