...
hp_tempRec = uipanel('Title','temperature & stimulus recordings', ...
    'Parent',mainFig,...
    'Units','normalized', ...
    'Position',[0.12 0.02 0.62 0.06],...
    'FontUnits','normalized', ...
    'FontSize',0.25,'FontWeight','bold');

h_pb_selectTempDir = uicontrol('Style','pushbutton',...
    'String',['<html> <p align="center"> select dir <br/>', ...
              '<i> <span style="font-size:50%">(both temperature and ', ...
              'stimulus record)</span></i> <html>'], ...
    'FontUnits','normalized', 'FontSize',0.4, ...
    'FontWeight','bold', 'Units','normalized',...
    'Parent',hp_tempRec, 'Position', [0.0025 0.01 0.135 0.95],...
    'Callback',{@getTemperatureRecord, mainFig, true, true});

uicontrol('Style','text', ...
    'FontUnits','normalized',...
    'Parent',hp_tempRec, 'Units','normalized', 'FontSize',0.3,...
    'Position',[0.135 0.01 0.05 0.95], ...
    'HorizontalAlignment','center', ...
    'String',{'trigger', 'delay (s):'});
h_edit_triggerDelay = uicontrol('Style', 'edit', ...
    'String','25', 'Parent',hp_tempRec, ...
    'Units','normalized', 'FontUnits','normalized', ...
    'Position',[0.185 0.01 0.075 0.95], ...
    'Units','normalized', 'FontSize',0.45, ...
    'TooltipString','delay used in protocol to trigger microscope recording in (s)',...
    'Callback','');

h_text_tempAndStimDirPath = uicontrol('Style','text', ...
    'FontUnits','normalized',...
    'Parent',hp_tempRec, 'Units','normalized', 'FontSize',0.3,...
    'Position',[0.27 0.01 0.73 0.95], ...
    'HorizontalAlignment','left', ...
    'TooltipString','',...
    'String','folder with stimulus and temperature recordings');

hObjs.h_pb_selectTempDir = h_pb_selectTempDir;
hObjs.h_edit_triggerDelay = h_edit_triggerDelay;
hObjs.h_text_tempAndStimDirPath = h_text_tempAndStimDirPath;
