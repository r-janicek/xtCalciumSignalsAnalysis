...
% 
% if ~isempty(locsPx)
%     for i=1:length(locsPx)
%         
%         if i==1
%             
%             if i==length(locsPx)
%                 
%                 pp1 = prof_s(1:locsPx(i));
...
%             end
%             
%         elseif i>1 && i==length(locsPx)
%            
%             pp1 = prof_s(locsPx(i-1):locsPx(i));
%             %calculate gradient from left to right
%             g_pp_l = gradient(pp1);
