...
for i = 1:Npeaks
    ...
    try
        eventsParams(i,:) = [eP.t0, eP.bs_t, eP.t_max, ... 
            ...
            eP.v_max, eP.amplitude, eP.TTP, eP.TTP_fittedLine, ...
            eP.FDHM, AUC, tauD, firstDerVal, t(firstDerPos)];
    catch
...
names_params = {'t0 (ms)', 'F0 (deltaF/F0)', 'tPeak (ms)', ...
    ...
    'TTP (ms)', 'TTP_fittedLine (ms)', ...
    'FDHM (ms)', 'AUC (ms*deltaF/F0)', 'tauD (ms)', ...
